        ...
        <div class="col-lg-6 py-10">
          <div class="row">
            <div class="col-md-8">
              <p>
                Thanks to
                <a href="javascript:;" class="underline">Opumo</a> for the
                product images used in this demo theme. Head over to
                <a href="javascript:;" class="underline">their store</a> to get
                these products.
              </p>
            </div>
          </div>
